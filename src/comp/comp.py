...
print("Starts with D:")
a = [name.name for name in humans if name.name[:1] == 'D']
print(a)
print(f"{humans}")
# Write a list comprehension that creates a list of names of everyone
...
c = [ name.name for name in humans if name.name[:1] == 'C' or name.name[:1] == 'D' or name.name[:1] == 'E' or name.name[:1] == 'F' or name.name[:1] == 'G']
print(c)
